...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 244.865370631217957, 226.0, 29.5, 22.0 ],
					"text" : "/ 8."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 287.044852614402771, 226.0, 29.5, 22.0 ],
					"text" : "/ 4."
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 287.044852614402771, 355.0, 72.564113736152649, 20.0 ],
					"text" : "float??????"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1195.0, 1162.0, 35.0, 22.0 ],
					"text" : "set 2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1087.0, 1123.0, 35.0, 22.0 ],
					"text" : "set 1"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 468.0, 191.0, 24.0, 24.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 324.294852614402771, 226.0, 29.5, 22.0 ],
					"text" : "/ 2."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 415.455105662345886, 226.0, 29.5, 22.0 ],
					"text" : "* 4"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 375.455105662345886, 226.0, 29.5, 22.0 ],
					"text" : "* 2"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 333.044852614402771, 263.0, 60.0, 32.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 352.205105662345886, 190.024407267570496, 50.0, 22.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
							"parameter_invisible" : 1,
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 1388.461455702781677, 1099.999934434890747, 41.0, 32.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 456.0, 982.0, 50.0, 22.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
							"parameter_invisible" : 1,
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 343.0, 1127.0, 50.0, 22.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
							"parameter_invisible" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 343.0, 1162.0, 51.0, 22.0 ],
					"text" : "rows $1"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 475.0, 1036.0, 50.0, 22.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
							"parameter_invisible" : 1,
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 419.0, 1036.0, 50.0, 22.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
							"parameter_invisible" : 1,
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 537.0, 1070.0, 24.0, 24.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
							"parameter_enum" : [ "off", "on" ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 10,
					"outlettype" : [ "float", "list", "float", "float", "float", "float", "float", "", "int", "" ],
					"patching_rect" : [ 537.0, 1102.0, 113.5, 22.0 ],
					"text" : "info~ song"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 459.0, 1119.0, 72.0, 22.0 ],
					"text" : "phasor~ 0.5"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 419.0, 1092.0, 86.0, 22.0 ],
					"text" : "phasor~ 0.005"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 551.0, 1148.0, 66.0, 22.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
							"parameter_invisible" : 1,
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 494.0, 1151.0, 50.0, 22.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
							"parameter_invisible" : 1,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 459.0, 1241.0, 45.0, 45.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 419.0, 1192.0, 136.0, 22.0 ],
					"text" : "2d.wave~ song 0. 0. 2 1"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1624.39028263092041, 851.219532489776611, 150.0, 20.0 ],
					"text" : "no white space"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1546.341500282287598, 958.536608219146729, 168.0, 20.0 ],
					"text" : "converts to nums from 1 - 26"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1553.658573627471924, 678.048796653747559, 150.0, 20.0 ],
					"text" : "from letters to ascii"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 874.5, 649.999961256980896, 50.0, 22.0 ],
					"text" : "4"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1394.871711730957031, 1044.871732592582703, 69.0, 22.0 ],
					"text" : "r barTempo"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1458.536620140075684, 1219.512224197387695, 82.0, 22.0 ],
					"text" : "s numSample"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1475.609791278839111, 221.951224803924561, 73.0, 22.0 ],
					"text" : "r bangAgain"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1548.780524730682373, 1219.512224197387695, 75.0, 22.0 ],
					"text" : "s bangAgain"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 1548.780524730682373, 1187.804906368255615, 34.0, 22.0 ],
					"text" : "sel 0"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 1604.878087043762207, 1187.804906368255615, 50.0, 22.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
							"parameter_invisible" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1597.561013698577881, 1146.341490745544434, 43.0, 22.0 ],
					"text" : "zlclear"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 1388.461455702781677, 1145.341490745544434, 24.0, 24.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
							"parameter_enum" : [ "off", "on" ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1334.615305066108704, 1044.871732592582703, 49.0, 22.0 ],
					"text" : "r tempo"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1485.365889072418213, 1187.804906368255615, 50.0, 22.0 ],
					"text" : "4"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 1404.878082275390625, 375.60976505279541, 54.0, 22.0 ],
					"text" : "delay 10"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1502.439060211181641, 436.585376262664795, 39.0, 22.0 ],
					"text" : "dump"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1663.414673805236816, 456.097571849822998, 35.0, 22.0 ],
					"text" : "clear"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 1514.634182453155518, 1036.585390567779541, 24.0, 24.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
							"parameter_enum" : [ "off", "on" ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 1517.073206901550293, 1146.341490745544434, 54.0, 22.0 ],
					"text" : "zl.queue"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 990.0, 1034.0, 45.0, 45.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 246.044852614402771, 154.0, 43.0, 20.0 ],
					"text" : "BPM"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 203.871795177459717, 469.230741262435913, 71.0, 22.0 ],
					"text" : "s barTempo"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 201.307692766189575, 439.743563532829285, 91.578940272331238, 20.0 ],
					"text" : "bar converter "
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 209.0, 399.99997615814209, 34.0, 22.0 ],
					"text" : "sel 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 303.871789216995239, 399.99997615814209, 29.5, 22.0 ],
					"text" : "+ 1"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 303.871789216995239, 429.487153887748718, 51.0, 22.0 ],
					"text" : "s tempo"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 223.044852614402771, 106.0, 77.0, 22.0 ],
					"text" : "loadmess 84"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 1570.731744766235352, 521.951231956481934, 47.0, 22.0 ],
					"text" : "delay 5"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 1570.731744766235352, 558.536598682403564, 24.0, 24.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
							"parameter_enum" : [ "off", "on" ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1514.634182453155518, 992.682950496673584, 59.0, 22.0 ],
					"text" : "thresh 20"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 1514.634182453155518, 956.097583770751953, 29.5, 22.0 ],
					"text" : "- 96"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 1514.634182453155518, 921.951241493225098, 47.0, 22.0 ],
					"text" : "zl.iter 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1546.341500282287598, 851.219532489776611, 77.0, 22.0 ],
					"text" : "loadmess 32"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 1512.195158004760742, 885.365874767303467, 57.0, 22.0 ],
					"text" : "zl.unique"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 1514.634182453155518, 729.268310070037842, 24.0, 24.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
							"parameter_enum" : [ "off", "on" ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 1548.780524730682373, 256.097567081451416, 50.0, 22.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
							"parameter_invisible" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1548.780524730682373, 221.951224803924561, 77.0, 22.0 ],
					"text" : "loadmess 10"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "list" ],
					"patching_rect" : [ 1514.634182453155518, 678.048796653747559, 40.0, 22.0 ],
					"text" : "atoi"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 1682.92686939239502, 429.268302917480469, 24.0, 24.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
							"parameter_enum" : [ "off", "on" ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 1475.609791278839111, 260.975615978240967, 24.0, 24.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
							"parameter_enum" : [ "off", "on" ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "bang", "int" ],
					"patching_rect" : [ 1570.731744766235352, 463.414645195007324, 40.0, 22.0 ],
					"text" : "text"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 1475.609791278839111, 339.024398326873779, 40.0, 22.0 ],
					"text" : "Uzi"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 1648.780527114868164, 334.146349430084229, 150.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1695.121991634368896, 363.414642810821533, 35.0, 22.0 ],
					"text" : "clear"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1743.902480602264404, 385.365862846374512, 34.0, 22.0 ],
					"text" : "build"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1641.463453769683838, 241.463420391082764, 39.0, 22.0 ],
					"text" : "dump"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "bang", "int" ],
					"patching_rect" : [ 1641.463453769683838, 278.048787117004395, 40.0, 22.0 ],
					"text" : "text"
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 1558.280524730682373, 288.65161395072937, 1505.855006217956543, 288.65161395072937, 1505.855006217956543, 327.65161395072937, 1506.109791278839111, 327.65161395072937 ],
					"order" : 1,
					"source" : [ "obj-15", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 1414.378082275390625, 420.65161395072937, 1511.939060211181641, 420.65161395072937 ],
					"source" : [ "obj-28", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 1485.109791278839111, 327.65161395072937, 1414.378082275390625, 327.65161395072937 ],
					"order" : 1,
					"source" : [ "obj-46", 0 ]
				}
...
, 			{
		...
		"parameters" : 		{
			...
			"obj-110" : [ "button[6]", "button[6]", 0 ],
			"obj-112" : [ "number[7]", "number[7]", 0 ],
			"obj-118" : [ "button[13]", "button[13]", 0 ],
			"obj-119" : [ "number[3]", "number[3]", 0 ],
			"obj-127" : [ "number[18]", "number[18]", 0 ],
			"obj-13" : [ "toggle[1]", "toggle[1]", 0 ],
			"obj-134" : [ "number[20]", "number[20]", 0 ],
			"obj-141" : [ "number[10]", "number[10]", 0 ],
			"obj-143" : [ "number[14]", "number[14]", 0 ],
			"obj-147" : [ "number[13]", "number[13]", 0 ],
			"obj-149" : [ "number[12]", "number[12]", 0 ],
			"obj-15" : [ "number", "number", 0 ],
			"obj-150" : [ "number[11]", "number[11]", 0 ],
			"obj-168" : [ "number[15]", "number[15]", 0 ],
			"obj-17" : [ "toggle", "toggle", 0 ],
			"obj-19" : [ "button[2]", "button[2]", 0 ],
			"obj-195" : [ "number[16]", "number[16]", 0 ],
			"obj-198" : [ "number[17]", "number[17]", 0 ],
			"obj-213" : [ "button[10]", "button[10]", 0 ],
			"obj-215" : [ "button[11]", "button[11]", 0 ],
			"obj-217" : [ "button[12]", "button[12]", 0 ],
			"obj-31" : [ "number[1]", "number[1]", 0 ],
			"obj-33" : [ "button[3]", "button[3]", 0 ],
			"obj-45" : [ "button[7]", "button[7]", 0 ],
			"obj-46" : [ "button", "button", 0 ],
			"obj-51" : [ "number[4]", "number[4]", 0 ],
			"obj-55" : [ "button[4]", "button[4]", 0 ],
			"obj-57" : [ "number[8]", "number[8]", 0 ],
			"obj-58" : [ "button[5]", "button[5]", 0 ],
			"obj-61" : [ "button[1]", "button[1]", 0 ],
			"obj-63" : [ "number[5]", "number[5]", 0 ],
			"obj-64" : [ "number[2]", "number[2]", 0 ],
			"obj-91" : [ "button[9]", "button[9]", 0 ],
